...
# ESPN Cricket Analysis Dashboard


## Problem Statement

This dashboard provides a detailed analysis of the India vs South Africa cricket match using data extracted from ESPN Cricinfo through web scraping. It helps users understand the flow of the game by presenting key match statistics, player performances, batting and bowling contributions, partnerships, and innings progression in an interactive format.
